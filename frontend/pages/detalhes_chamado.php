...
$stmt = $pdo->prepare("SELECT id, arquivo_base64 FROM anexos WHERE chamado_id = ?");
                ...
                <div class="row">
                    <?php foreach ($anexos as $anexo): ?>
                        <div class="col-md-4 mb-3">
                            <div class="card">
                                <div class="card-body">
                                    <a href="data:application/octet-stream;base64,<?= $anexo['arquivo_base64'] ?>" download="anexo_<?= $anexo['id'] ?>.bin" class="btn btn-primary btn-sm">Baixar Anexo</a>
                                </div>
                            </div>
                        </div>
                    <?php endforeach; ?>
